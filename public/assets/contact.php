...
else if(trim($country) == 'Selecciona tu país') {
	echo '<div class="error_message">Por favor selecciona tu país</div>';
	exit();
}
else if(trim($phone_contact)=='') {
	echo '<div class="error_message">Por favor ingresa tu telefono</div>';
	exit();
} 
else if(trim($email_contact) == '') {
	echo '<div class="error_message">Por favor ingresa tu email</div>';
	exit();
...
$e_subject = 'Tiene un mensaje de: ' . $name_contact . '.';
